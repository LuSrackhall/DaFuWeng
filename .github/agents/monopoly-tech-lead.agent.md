...
agents: ["Monopoly Product Manager", "Monopoly UI UX Director", "Monopoly Senior Implementer", "Monopoly QA Lead", "Monopoly Simulated Player", "Monopoly Release Marketer", "GitHub Copilot Workflow Expert"]
user-invocable: true
---
...
3. Convert decisions into implementation slices with validation checkpoints.
4. Keep the repository aligned with CI-first delivery and conventional commits.
