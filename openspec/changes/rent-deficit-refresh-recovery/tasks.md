...
- [ ] 3.1 Ensure room projection restores player-creditor rent deficit context from authoritative snapshots after refresh or reconnect.
- [ ] 3.2 Ensure only the debtor remains actionable during rent deficit recovery and all other players stay read-only.
