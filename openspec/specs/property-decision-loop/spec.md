...
Define the authoritative property purchase and decline loop for unowned purchasable tiles.
...
- **WHEN** the current acting player submits a valid `decline-property` command for an unowned tile
